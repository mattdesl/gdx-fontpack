...
public class FontPackToolOld extends JFrame {
...
//			freeTypeCard.row();
			...
			freeTypeCard.addCell("File:").left();
			
			JTextField fontFilePath = new JTextField();
			freeTypeCard.addCell(fontFilePath).left().width(250);
			freeTypeCard.left();
			...
			table.row();
			table.addCell(cardPanel).left().padTop(20);
